...
hl.config({
    general = {
        ...
        border_size = 0, -- Default 2

        col = {
            active_border   = "rgba(7a7a75ee)",
            inactive_border = "rgba(454540aa)",
        },
    ...
    decoration = {
        rounding       = 0, -- Default value is 10
        rounding_power = 2,
...
-- Standard wallpaper, commented out since we use Hyprpaper
hl.config({
    misc = {
